...
const bookLoading = require('../../Animations/error_cross.json'); 

export default class ReturnFailureToken extends React.Component {
  state = {
    animation: null,
  };
        ...
        <View>
            ...
            <View style={styles.containerView}>
                    <View style={styles.successTextView}>
                        <Text style={styles.successText}>RETURN FAILED!</Text>
                    </View>
