...
export default class IssueSuccessToken extends React.Component {
  state = {
    animation: null,
  };
        ...
        <View>
            ...
            <View style={styles.containerView}>
                    <View style={styles.successTextView}>
                        <Text style={styles.successText}>SUCCESSFULLY ISSUED!!!</Text>
                    </View>
                    <View style={styles.bodyView}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            <Text style={styles.bodyBlue}>Issue Date                :  </Text>
                            <Text style={styles.body}>January 1st, 2019</Text>
                        </View>
                        <View style={{flexDirection: 'row'}}>
